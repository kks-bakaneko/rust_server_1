...
use actix_web::{error, web, App, Error, HttpResponse, HttpServer, Result, web::Data};
...
async fn handle_get_tutors(tmpl: web::Data<tera::Tera>) -> Result<HttpResponse, Error> {
    let tutors: Vec<Tutor> = vec![
        ...
        Tutor {
            name: String::from("Tutor 6")
        },
        Tutor {
            name: String::from("Tutor 7")
        },
        Tutor {
            name: String::from("Tutor 8")
        },
        Tutor {
            name: String::from("Tutor 9")
        },
        Tutor {
            name: String::from("Tutor 10")
        },
    ];
